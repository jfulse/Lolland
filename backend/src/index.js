...
app.get('/login', (req, res) => {
  ...
  const scope = 'streaming user-read-birthdate user-read-private user-read-email user-library-read user-read-playback-state user-modify-playback-state playlist-read-private';
